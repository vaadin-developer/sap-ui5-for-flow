...
public class CoreUIJavaService
  ...
  public void startup(String[] args) throws ParseException {
    //setting defaults
    setProperty(CORE_UI_SERVER_PORT, CORE_UI_SERVER_PORT_DEFAULT);
    setProperty(CORE_UI_SERVER_HOST, CORE_UI_SERVER_HOST_DEFAULT);
    setProperty(CORE_UI_BASE_PKG, DEFAULT_BASE_PKG);
  ...
  public void startup() {
    ...
    try {
      ...
      Undertow u = Undertow.builder()
                           .addHttpListener(
                               Integer.parseInt(getProperty(CORE_UI_SERVER_PORT)),
  ...
  private Set<Class<?>> setOfRouteAnnotatedClasses() {
    return new Reflections(getProperty(CORE_UI_BASE_PKG)).getTypesAnnotatedWith(Route.class)
                                                                           .stream()
