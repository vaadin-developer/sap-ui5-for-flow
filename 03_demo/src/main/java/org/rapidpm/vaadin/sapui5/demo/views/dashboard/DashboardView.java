...
public class DashboardView
  ...
  public DashboardView() {
    ...
    final UI5Timeline ui5TimelineCool = new UI5Timeline();
    ui5TimelineCool.add(nextTimeLineItem());
    ui5TimelineCool.add(nextTimeLineItem());
    ui5TimelineCool.add(nextTimeLineItem());
    final UI5Timeline ui5TimelineNotNice = new UI5Timeline();
    ui5TimelineNotNice.add(nextTimeLineItem());
    ui5TimelineNotNice.add(nextTimeLineItem());


    board.addRow(createBadgeTimeLine("Cool", ui5TimelineCool, "badge success"),
                 createBadgeTimeLine("not Nice", ui5TimelineNotNice, "badge error"));
    ...
    grid.addColumn(HealthGridItem::getCity)
        .setHeader("City");
  ...
  private WrapperCard createBadge(String title, H2 h2, String h2ClassName, String description, String badgeTheme) {
    ...
    titleSpan.getElement()
             .setAttribute("theme", badgeTheme);
  ...
  private WrapperCard createBadgeTimeLine(String title, Component child, String badgeTheme) {
    Span titleSpan = new Span(title);
    titleSpan.getElement()
             .setAttribute("theme", badgeTheme);

    Div holder = new Div(child);
//    holder.addClassName("secondary-text");

    return new WrapperCard("wrapper", new Component[]{titleSpan, holder}, "card", "space-m");
  }
  ...
  public void afterNavigation(AfterNavigationEvent event) {
    ...
    gridItems.add(
        new HealthGridItem(LocalDate.of(2019, 1, 14), "Lancaster", "United States", "Excellent", "badge success"));
    ...
    configuration.addSeries(
        new ListSeries("Tokyo", 7.0, 6.9, 9.5, 14.5, 18.2, 21.5, 25.2, 26.5, 23.3, 18.3, 13.9, 9.6));
